...
with open(r'D:/DHKL17A2HN_PYTHON NC/BAITAP_Chương3/heights.txt', 'r', encoding='utf-8-sig') as f:
    read = f.readlines()
    heights = list(map(lambda x: float(x), read[0].split(',')))

with open(r'D:/DHKL17A2HN_PYTHON NC/BAITAP_Chương3/positions.txt', 'r', encoding='utf-8-sig') as f:
    read = f.readlines()
